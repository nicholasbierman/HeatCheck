...
export const NavBar = () => {
  return (
    <nav style={ { height: "fit-content", color: "whitesmoke", margin: "0 0 60px 0", display: "flex", backgroundColor: "#fe5500", width: "100%" } }>
      <ul style={ { listStyle: "none", display: "flex", alignItems: "center", width: "100%", justifyContent: "start" } }>
        <li style={{marginRight: "15%", fontSize: "30px"}}>HeatCheck<span role="img"></span>🔥✅</li>
